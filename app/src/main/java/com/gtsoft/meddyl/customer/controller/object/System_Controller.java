...
public class System_Controller extends Base_Controller implements Parcelable
{
	...
	public System_Controller(Context context)
	{
	}
	...
	private System_Controller(Parcel in)
	{
	...
	public static final Parcelable.Creator<System_Controller> CREATOR = new Parcelable.Creator<System_Controller>() 
	{
		public System_Controller createFromParcel(Parcel in) 
		{
			return new System_Controller(in);
		}

		public System_Controller[] newArray(int size) 
		{
			return new System_Controller[size];
		}
	};

	public void Get_Application_Settings()
	{
		...
		i_rest.Get_Application_Settings(login_log_obj);
		...
		else
		{
			...
			application_type_obj = (Application_Type)i_rest.getJSONSuccessfulResponse().getDataObj();
		}
	}

	public void Get_System_Settings()
	{
		system_error_obj = null;
		system_successful_obj = null;

		system_settings_obj = new System_Settings();
		system_settings_obj.setLoginLogObj(login_log_obj);

		REST_CustomerService i_rest = new REST_CustomerService(customer_service);
		i_rest.Get_System_Settings(system_settings_obj);
		...
		{
			system_successful_obj = i_rest.getJSONSuccessfulResponse().getSystemSuccessful();
			system_settings_obj = (System_Settings)i_rest.getJSONSuccessfulResponse().getDataObj();
		}
	}

	public void Get_Industry_Parent_Level()
	{
		system_error_obj = null;
		system_successful_obj = null;
		...
		REST_CustomerService i_rest = new REST_CustomerService(customer_service);
		i_rest.Get_Industry_Parent_Level(industry_obj);
		...
		{
			system_successful_obj = i_rest.getJSONSuccessfulResponse().getSystemSuccessful();
			industry_obj_array = (Industry[])i_rest.getJSONSuccessfulResponse().getDataObj();
		}
	}
